        ...
        cards = data.plugins.map(function (item) {
          return React.createElement(
            ...
            React.createElement(
              ...
              React.createElement("span", { className: "sc-badge" + (item.loaded ? " is-on" : "") }, item.loaded ? "已加载" : "未写入 patch"),
            ),
    ...
    function apply(ctx) {
      ...
      ctx.slots.inject("conversation.view", function () {
        return ctx.slots.register(
          { name: "conversation.view", id: "shichang", order: 40, label: "市场" },
          function () {
            return React.createElement(MarketApp);
          },
        );
      });
    }
